...
print(
    "This program will show the electric field and potential around a uniformly distributed square of charge."
)
sleep(2)
...
system = System(
    [
        FiniteLineCharge(charge / 4, Point(3, 7), Point(7, 7), 100),
