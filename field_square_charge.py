...
print("This program will show the electric field lines around a uniformly distributed square of charge.")
sleep(2)
...
render_system(system, minimum=Point(0, 0), maximum=Point(10, 10), title="Electric field lines around a square of charge", size=100)